...
Six frontier LLM agents independently audited the Kleidi codebase at its exact pre-Code4rena state (`0d72b6cb5725c1380212dc76257da96fcfacf22f`, 2024-10-17), blind to the C4 findings. This repo contains the full comparative report, each model's raw findings, and the primary evidence (codebase snapshot, provenance, Certora baseline).
...
3. Consolidated findings (13 distinct issues, per-finding cards)
4. Model-by-model analysis
5. Scoring vs. C4 ground truth + Certora baseline comparison
...
(DeepSeek's Morpho finding was reported High; review re-rated it Medium — see REPORT.md §3 F7.)
